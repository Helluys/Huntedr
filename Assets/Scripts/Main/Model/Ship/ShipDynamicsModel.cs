...
public class ShipDynamicsModel : ScriptableObject {
    ...
    public Matrix4x4 linearFrictionMatrix_linear = Extension.Mathf.ScaleMatrix(Matrix4x4.identity, -0.2f);
    ...
    public Matrix4x4 rotationalFrictionMatrix_linear = Extension.Mathf.ScaleMatrix(Matrix4x4.identity, -0.2f);
